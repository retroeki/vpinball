...
SimpleStatement
    ...
    /* REMOVED: Orphan End If rule was causing shift-reduce conflict with End Sub/End Function */
    /* The parser would shift tEND expecting tIF, but fail when it saw tSUB instead */
