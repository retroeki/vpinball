...
Const SongVolume = 0.2 ' 1 is full volume. Value is from 0 to 1
...
Const TableName = "The Real Ghostbusters"
...
'* TABLE OPTIONS *******************************************************
'***********************************************************************
Dim IsGlowBall:IsGlowball=true
...
Sub Table1_Exit
    ...
    If B2SOn = true Then Exit Sub ' Controller.Stop disabled for Android
End Sub
...
Sub swPlungerRest_Hit()
    ...
    If bSkillShotReady Then
        ...
        If bSkillShotPlayedOnce = False Then 'play the sound just once per game
            vpmtimer.addtimer 500, "PlaySound ""vo_chooseskillshot"" '"
            bSkillShotPlayedOnce = False
        End If
        UpdateSkillshot()
    End If
...
Sub DMDHead()
    ...
    For i = 0 to 2
        vpx_ssc_tmp = dqEffect(i, dqHead) : Select Case vpx_ssc_tmp
...
Sub ShowTableInfo
    ...
    Else
        ...
        End If
    End If
    DMD "", "", "jppresents", eNone, eNone, eNone, 3000, False, "" 'jpsalas presents
    DMD "", "", "jpm", eNone, eNone, eNone, 3000, False, "" 'a Jonpfeiler Mod
...
Sub NextLUT:LUTImage = (LUTImage + 1)MOD 19:UpdateLUT:SaveLUT:Lutbox.text = "level of darkness " & LUTImage + 1:End Sub
...
Sub UpdateLUT
    Select Case LutImage
        ...
        Case 9:table1.ColorGradeImage = "LUT_Blue_daylight":GiIntensity = 1:ChangeGIIntensity 1
        Case 10:table1.ColorGradeImage = "LUT_Blue_dark":GiIntensity = 1.05:ChangeGIIntensity 1
        Case 11:table1.ColorGradeImage = "LUT_Blue_darker":GiIntensity = 1.1:ChangeGIIntensity 1
        Case 12:table1.ColorGradeImage = "LUT_Blue_night":GiIntensity = 1.15:ChangeGIIntensity 1
        Case 13:table1.ColorGradeImage = "LUT_Blue_pitch-dark":GiIntensity = 1.2:ChangeGIIntensity 1
        Case 14:table1.ColorGradeImage = "LUT_Light_Blue_daylight":GiIntensity = 1:ChangeGIIntensity 1
        Case 15:table1.ColorGradeImage = "LUT_Light_Blue_dark":GiIntensity = 1.05:ChangeGIIntensity 1
        Case 16:table1.ColorGradeImage = "LUT_Light_Blue_darker":GiIntensity = 1.1:ChangeGIIntensity 1
        Case 17:table1.ColorGradeImage = "LUT_Light_Blue_night":GiIntensity = 1.15:ChangeGIIntensity 1
        Case 18:table1.ColorGradeImage = "LUT_Light_Blue_pitch-dark":GiIntensity = 1.2:ChangeGIIntensity 1
    End Select
End Sub
...
Sub sw12_Hit() 'left loop
    ...
    If l14.State = 1 Then 'catch ghost
        ...
        CatchGhost 1
    End If
    vpx_ssc_tmp = Modes(0) : Select Case vpx_ssc_tmp
        Case 2
            if l61.State = 2 Then
                BackFlashEffect 1
...
Sub Bumper1_Hit
    ...
    AddScore 500 + 4500 * ABS(Bumper1Light.Visible) 'a bumper scores 500 points and 5000 points when lit
...
Sub Bumper2_Hit
    ...
    DOF 110, DOFPulse
    FlashForMs BumperFlash, 500, 50, 0:FlashForMs BumperFlash1, 500, 50, 0
    AddScore 500 + 4500 * ABS(Bumper1Light.Visible) 'a bumper scores 100 points and 1000 points when lit
...
Sub CheckBumpers()
	...
	DMDFlush
    DMD "    BUMPER AWARD", tmp, "", eNone, eNone, eNone, 250, True, ""
...
Sub GozerHurryUp_Timer()
    ...
    DMD "", "Samhain: " &FormatScore(GozerAward), "", eNone, eNone, eNone, 500, True, ""
End Sub
...
Sub StartGozerian()
    DMD CL(0, "Samhain"), CL(1, "STARTED"), "", eNone, eBlinkFast, eNone, 1000, True, "vo_gozerthegozerian"
    ' reset the count each time you start the mode
    GozerianHits = 0
    SetLightColor l61, "yellow", 2
    SetLightColor l62, "amber", 2
...
Sub CheckGozerianHits()
    Select Case GozerianHits
        ...
        Case 2
            DMD CL(0, "Samhain"), CL(1, "COMPLETED"), "", eNone, eBlinkFast, eNone, 1500, True, ""
            Congratulation:FlashEffect 1
            Modes(0) = 0
            Modes(8) = 1
            UpdateModeLights
