...
Sub ResetVRRoom
	...
	Dim ssp_i3
	If IsArray(VR_Cab) Then
		For ssp_i3 = 0 To UBound(VR_Cab)
			Set Stuff = VR_Cab(ssp_i3)
			Stuff.visible = False
		Next
	End If
	Dim ssp_i4
	If IsArray(VR_Room) Then
		For ssp_i4 = 0 To UBound(VR_Room)
			Set Stuff = VR_Room(ssp_i4)
			Stuff.visible = False
		Next
	End If
	Dim ssp_i5
	If IsArray(VR_IronThrone) Then
		For ssp_i5 = 0 To UBound(VR_IronThrone)
			Set Stuff = VR_IronThrone(ssp_i5)
			Stuff.visible = False
		Next
	End If
    Dim ssp_i6
    If IsArray(VR_DragonIce) Then
    	For ssp_i6 = 0 To UBound(VR_DragonIce)
    		Set Stuff = VR_DragonIce(ssp_i6)
    		Stuff.visible = False
    	Next
    End If
    Dim ssp_i7
    If IsArray(VR_TowerThrone) Then
    	For ssp_i7 = 0 To UBound(VR_TowerThrone)
    		Set Stuff = VR_TowerThrone(ssp_i7)
    		Stuff.visible = False
    	Next
    End If
	Dim ssp_i8
	If IsArray(VR_Topper) Then
		For ssp_i8 = 0 To UBound(VR_Topper)
			Set Stuff = VR_Topper(ssp_i8)
			Stuff.visible = False
		Next
	End If
...
Sub VRRoomInit 
	...
	If 0 = 2 or VRTest = 1 Then VRRoom = VRRoomChoice Else VRRoom = 0
    ...
    If VRRoom = 1 Then 
        ...
        Dim ssp_i9
        If IsArray(VR_Cab) Then
        	For ssp_i9 = 0 To UBound(VR_Cab)
        		Set Stuff = VR_Cab(ssp_i9)
        		Stuff.visible = true
        	Next
        End If
        Dim ssp_i10
        If IsArray(VR_Room) Then
        	For ssp_i10 = 0 To UBound(VR_Room)
        		Set Stuff = VR_Room(ssp_i10)
        		Stuff.visible = true
        	Next
        End If
        Dim ssp_i11
        If IsArray(VR_IronThrone) Then
        	For ssp_i11 = 0 To UBound(VR_IronThrone)
        		Set Stuff = VR_IronThrone(ssp_i11)
        		Stuff.visible = False
        	Next
        End If
        Dim ssp_i12
        If IsArray(VR_DragonIce) Then
        	For ssp_i12 = 0 To UBound(VR_DragonIce)
        		Set Stuff = VR_DragonIce(ssp_i12)
        		Stuff.visible = False
        	Next
        End If
        Dim ssp_i13
        If IsArray(VR_TowerThrone) Then
        	For ssp_i13 = 0 To UBound(VR_TowerThrone)
        		Set Stuff = VR_TowerThrone(ssp_i13)
        		Stuff.visible = False
        	Next
        End If
        Dim ssp_i14
        If IsArray(VR_Topper) Then
        	For ssp_i14 = 0 To UBound(VR_Topper)
        		Set Stuff = VR_Topper(ssp_i14)
        		Stuff.visible = (Topper=1)
        	Next
        End If
    ...
    If VRRoom = 2 Then 
        Dim ssp_i15
        If IsArray(VR_UltraMin) Then
        	For ssp_i15 = 0 To UBound(VR_UltraMin)
        		Set Stuff = VR_UltraMin(ssp_i15)
        		Stuff.visible = true
        	Next
        End If
        ...
        Dim ssp_i16
        If IsArray(VR_DragonIce) Then
        	For ssp_i16 = 0 To UBound(VR_DragonIce)
        		Set Stuff = VR_DragonIce(ssp_i16)
        		Stuff.visible = False
        	Next
        End If
        Dim ssp_i17
        If IsArray(VR_TowerThrone) Then
        	For ssp_i17 = 0 To UBound(VR_TowerThrone)
        		Set Stuff = VR_TowerThrone(ssp_i17)
        		Stuff.visible = False
        	Next
        End If
        Dim ssp_i18
        If IsArray(VR_Room) Then
        	For ssp_i18 = 0 To UBound(VR_Room)
        		Set Stuff = VR_Room(ssp_i18)
        		Stuff.visible = false
        	Next
        End If
        Dim ssp_i19
        If IsArray(VR_IronThrone) Then
        	For ssp_i19 = 0 To UBound(VR_IronThrone)
        		Set Stuff = VR_IronThrone(ssp_i19)
        		Stuff.visible = false
        	Next
        End If
		Dim ssp_i20
		If IsArray(VR_Topper) Then
			For ssp_i20 = 0 To UBound(VR_Topper)
				Set Stuff = VR_Topper(ssp_i20)
				Stuff.visible = false
			Next
		End If
    End if
    ...
    If VRRoom = 3 Then 
        ...
        Dim ssp_i21
        If IsArray(VR_Cab) Then
        	For ssp_i21 = 0 To UBound(VR_Cab)
        		Set Stuff = VR_Cab(ssp_i21)
        		Stuff.visible = true
        	Next
        End If
        Dim ssp_i22
        If IsArray(VR_Room) Then
        	For ssp_i22 = 0 To UBound(VR_Room)
        		Set Stuff = VR_Room(ssp_i22)
        		Stuff.visible = false
        	Next
        End If
        Dim ssp_i23
        If IsArray(VR_IronThrone) Then
        	For ssp_i23 = 0 To UBound(VR_IronThrone)
        		Set Stuff = VR_IronThrone(ssp_i23)
        		Stuff.visible = true
        	Next
        End If
        Dim ssp_i24
        If IsArray(VR_Topper) Then
        	For ssp_i24 = 0 To UBound(VR_Topper)
        		Set Stuff = VR_Topper(ssp_i24)
        		Stuff.visible = (Topper=1)
        	Next
        End If
        If Scratches = 1 then GlassImpurities.visible = true
    ...
    If VRRoom = 4 Then 
        ...
        Dim ssp_i25
        If IsArray(VR_Cab) Then
        	For ssp_i25 = 0 To UBound(VR_Cab)
        		Set Stuff = VR_Cab(ssp_i25)
        		Stuff.visible = true
        	Next
        End If
        Dim ssp_i26
        If IsArray(VR_Room) Then
        	For ssp_i26 = 0 To UBound(VR_Room)
        		Set Stuff = VR_Room(ssp_i26)
        		Stuff.visible = false
        	Next
        End If
        Dim ssp_i27
        If IsArray(VR_IronThrone) Then
        	For ssp_i27 = 0 To UBound(VR_IronThrone)
        		Set Stuff = VR_IronThrone(ssp_i27)
        		Stuff.visible = False
        	Next
        End If
        Dim ssp_i28
        If IsArray(VR_DragonIce) Then
        	For ssp_i28 = 0 To UBound(VR_DragonIce)
        		Set Stuff = VR_DragonIce(ssp_i28)
        		Stuff.visible = True
        	Next
        End If
        Dim ssp_i29
        If IsArray(VR_TowerThrone) Then
        	For ssp_i29 = 0 To UBound(VR_TowerThrone)
        		Set Stuff = VR_TowerThrone(ssp_i29)
        		Stuff.visible = False
        	Next
        End If
        Dim ssp_i30
        If IsArray(VR_Topper) Then
        	For ssp_i30 = 0 To UBound(VR_Topper)
        		Set Stuff = VR_Topper(ssp_i30)
        		Stuff.visible = (Topper=1)
        	Next
        End If
        If Scratches = 1 then GlassImpurities.visible = true
    ...
    If VRRoom = 5 Then 
        ...
        Dim ssp_i31
        If IsArray(VR_Cab) Then
        	For ssp_i31 = 0 To UBound(VR_Cab)
        		Set Stuff = VR_Cab(ssp_i31)
        		Stuff.visible = true
        	Next
        End If
        Dim ssp_i32
        If IsArray(VR_Room) Then
        	For ssp_i32 = 0 To UBound(VR_Room)
        		Set Stuff = VR_Room(ssp_i32)
        		Stuff.visible = false
        	Next
        End If
        Dim ssp_i33
        If IsArray(VR_IronThrone) Then
        	For ssp_i33 = 0 To UBound(VR_IronThrone)
        		Set Stuff = VR_IronThrone(ssp_i33)
        		Stuff.visible = False
        	Next
        End If
        Dim ssp_i34
        If IsArray(VR_DragonIce) Then
        	For ssp_i34 = 0 To UBound(VR_DragonIce)
        		Set Stuff = VR_DragonIce(ssp_i34)
        		Stuff.visible = False
        	Next
        End If
        Dim ssp_i35
        If IsArray(VR_TowerThrone) Then
        	For ssp_i35 = 0 To UBound(VR_TowerThrone)
        		Set Stuff = VR_TowerThrone(ssp_i35)
        		Stuff.visible = True
        	Next
        End If
        Dim ssp_i36
        If IsArray(VR_Topper) Then
        	For ssp_i36 = 0 To UBound(VR_Topper)
        		Set Stuff = VR_Topper(ssp_i36)
        		Stuff.visible = (Topper=1)
        	Next
        End If
        If Scratches = 1 then GlassImpurities.visible = true
...
Sub Table1_Init()
	...
	if b2son then 
		...
		On Error Resume Next : On Error Resume Next : Controller.B2SSetData 1,1  : On Error Goto 0: On Error Goto 0
		On Error Resume Next : On Error Resume Next : Controller.B2SSetData 2,1  : On Error Goto 0: On Error Goto 0
		On Error Resume Next : On Error Resume Next : Controller.B2SSetData 3,1  : On Error Goto 0: On Error Goto 0
		On Error Resume Next : On Error Resume Next : Controller.B2SSetData 4,1  : On Error Goto 0: On Error Goto 0
		On Error Resume Next : On Error Resume Next : Controller.B2SSetData 5,1  : On Error Goto 0: On Error Goto 0
		On Error Resume Next : On Error Resume Next : Controller.B2SSetData 6,1  : On Error Goto 0: On Error Goto 0
		On Error Resume Next : On Error Resume Next : Controller.B2SSetData 7,1  : On Error Goto 0: On Error Goto 0
		On Error Resume Next : On Error Resume Next : Controller.B2SSetData 8,1  : On Error Goto 0: On Error Goto 0
	End if 
...
Sub Table1_Exit()
    ...
    If B2SOn Then Exit Sub ' Controller.Stop disabled for Android
	On Error Goto 0
End Sub
...
Sub Table1_KeyDown(ByVal Keycode)
	...
	If keycode = RightMagnaSave or keycode = LockBarKey or _  
		...
		Dim ssp_i37
		If IsArray(LockdownButton_BL) Then
			For ssp_i37 = 0 To UBound(LockdownButton_BL)
				Set Stuff = LockdownButton_BL(ssp_i37)
				Stuff.z = Stuff.z - 5
			Next
		End If
		Dim ssp_i38
		If IsArray(LockdownButton_BM) Then
			For ssp_i38 = 0 To UBound(LockdownButton_BM)
				Set Stuff = LockdownButton_BM(ssp_i38)
				Stuff.z = Stuff.z - 5
			Next
		End If
...
Sub Table1_KeyUp(ByVal keycode)
	...
	If keycode = RightMagnaSave or keycode = LockBarKey or _  
		...
		Dim ssp_i39
		If IsArray(LockdownButton_BL) Then
			For ssp_i39 = 0 To UBound(LockdownButton_BL)
				Set Stuff = LockdownButton_BL(ssp_i39)
				Stuff.z = Stuff.z + 5
			Next
		End If
		Dim ssp_i40
		If IsArray(LockdownButton_BM) Then
			For ssp_i40 = 0 To UBound(LockdownButton_BM)
				Set Stuff = LockdownButton_BM(ssp_i40)
				Stuff.z = Stuff.z + 5
			Next
		End If
		...
		If DynamicBallShadowsOn Then
			If gBOT(s).Z < 30 And gBOT(s).X < 850 Then	'Parameters for where the shadows can show, here they are not visible above the table (no upper pf) or in the plunger lane
				...
				For iii = 0 to numberofsources - 1 ' Search the 2 nearest influencing lights
					LSd = Distance(gBOT(s).x, gBOT(s).y, ssp_idx(DSSources(iii), 0), ssp_idx(DSSources(iii), 1)) 'Calculating the Linear distance to the Source
...
'					If LSd < dist2 And ((DSGISide(iii) = 0 And Lampz.State(100)>0) Or (DSGISide(iii) = 1 And Lampz.State(104)>0)) Then	'Adapted for TZ with GI left / GI right
				...
				If dist1 < falloff Then
					...
					objrtx1(s).rotz = AnglePP(ssp_idx(DSSources(src1), 0), ssp_idx(DSSources(src1), 1), gBOT(s).X, gBOT(s).Y) + 90
				...
				If dist2 < falloff Then
					...
					objrtx2(s).rotz = AnglePP(ssp_idx(DSSources(src2), 0), ssp_idx(DSSources(src2), 1), gBOT(s).X, gBOT(s).Y) + 90
...
Sub LeftSlingShot_Slingshot
    ...
    DOF 103, DOFPulse
    Dim sl, ssp_i0
    If IsArray(LSling2_BL) Then
    	For ssp_i0 = 0 To UBound(LSling2_BL)
    		Set sl = LSling2_BL(ssp_i0)
    		sl.visible = 0
    	Next
    End If
    Dim ssp_i41
    If IsArray(LSling1_BL) Then
    	For ssp_i41 = 0 To UBound(LSling1_BL)
    		Set sl = LSling1_BL(ssp_i41)
    		sl.visible = 1
    	Next
    End If
    Lemk.RotX = 26
...
Sub LeftSlingShot_Timer
    ...
    Dim ssp_i42
    If IsArray(LSling2_BL) Then
    	For ssp_i42 = 0 To UBound(LSling2_BL)
    		Set sl = LSling2_BL(ssp_i42)
    		sl.visible = v2
    	Next
    End If
    Dim ssp_i43
    If IsArray(LSling1_BL) Then
    	For ssp_i43 = 0 To UBound(LSling1_BL)
    		Set sl = LSling1_BL(ssp_i43)
    		sl.visible = v1
    	Next
    End If
    LStep = LStep + 1
...
Sub RightSlingShot_Slingshot
    ...
    DOF 104,DOFPulse
    Dim sl, ssp_i1
    If IsArray(RSling2_BL) Then
    	For ssp_i1 = 0 To UBound(RSling2_BL)
    		Set sl = RSling2_BL(ssp_i1)
    		sl.visible = 0
    	Next
    End If
    Dim ssp_i44
    If IsArray(RSling1_BL) Then
    	For ssp_i44 = 0 To UBound(RSling1_BL)
    		Set sl = RSling1_BL(ssp_i44)
    		sl.visible = 1
    	Next
    End If
    Remk.RotX = 26
...
Sub RightSlingShot_Timer
    ...
    Dim ssp_i45
    If IsArray(RSling2_BL) Then
    	For ssp_i45 = 0 To UBound(RSling2_BL)
    		Set sl = RSling2_BL(ssp_i45)
    		sl.visible = v2
    	Next
    End If
    Dim ssp_i46
    If IsArray(RSling1_BL) Then
    	For ssp_i46 = 0 To UBound(RSling1_BL)
    		Set sl = RSling1_BL(ssp_i46)
    		sl.visible = v1
    	Next
    End If
    RStep = RStep + 1
			...
			select case serviceLevel
				...
				case kMenuAdjStd,kMenuAdjGame:
					if DMDMenu(serviceIdx).ValType="FUN" then		' Function
                        vpx_ssc_tmp = DMDMenu(serviceIdx) : Select Case vpx_ssc_tmp.StdIdx
                            Case 0: reseths
                            Case 1: ClearAll
                        End Select
...
Class cHouse
    ...
    Public Property Let MyHouse(h) 
        ...
        ElseIf h = Targaryen Then
            vpx_ssc_tmp = DMDStd(kDMDFet_TargaryenHousePower) : Select Case vpx_ssc_tmp
...
Sub VPObjects_Init
    Dim i,sl
    BumperWeightTotal = 0
    For i = 1 To BumperAwards:BumperWeightTotal = BumperWeightTotal + ssp_idx(PictoPops(i), 2): Next
    Dim ssp_i47
    If IsArray(RSling1_BL) Then
    	For ssp_i47 = 0 To UBound(RSling1_BL)
    		Set sl = RSling1_BL(ssp_i47)
    		sl.visible = 0
    	Next
    End If
    Dim ssp_i48
    If IsArray(LSling1_BL) Then
    	For ssp_i48 = 0 To UBound(LSling1_BL)
    		Set sl = LSling1_BL(ssp_i48)
    		sl.visible = 0
    	Next
    End If
    Dim ssp_i49
    If IsArray(RSling2_BL) Then
    	For ssp_i49 = 0 To UBound(RSling2_BL)
    		Set sl = RSling2_BL(ssp_i49)
    		sl.visible = 0
    	Next
    End If
    Dim ssp_i50
    If IsArray(LSling2_BL) Then
    	For ssp_i50 = 0 To UBound(LSling2_BL)
    		Set sl = LSling2_BL(ssp_i50)
    		sl.visible = 0
    	Next
    End If
...
Sub ResetForNewPlayerBall()
    ...
    if (House(CurrentPlayer).MyHouse = 0) Then
        vpx_ssc_tmp = DMDStd(kDMDFet_PlayerHouseChoice) : Select Case vpx_ssc_tmp
            Case 0
                'PlayerMode = -1
				SetPlayerMode -1
                SelectedHouse = 1
...
Sub SetLockbarLight
    ...
    if st < 2 Then
		...
		if Cabinetmode And 0 <> 2 And Not bHaveLockbarButton Then
...
sub DoRam(vel)
	...
	if RamSettleTimer.enabled <> 0 then 
		...
		Dim ssp_i51
		If IsArray(ram_BL) Then
			For ssp_i51 = 0 To UBound(ram_BL)
				Set f = ram_BL(ssp_i51)
				f.transy = 0
			Next
		End If
	end if
...
Sub RamTimer_Timer
	...
	Dim ssp_i52
	If IsArray(ram_BL) Then
		For ssp_i52 = 0 To UBound(ram_BL)
			Set f = ram_BL(ssp_i52)
			f.transy = -(curHeight)
		Next
	End If
...
Sub RamSettleTimer_Timer
	...
	if RamSettleTimer.UserValue < cInt(RamVelocity/4) then
		...
		Dim ssp_i53
		If IsArray(ram_BL) Then
			For ssp_i53 = 0 To UBound(ram_BL)
				Set f = ram_BL(ssp_i53)
				f.transy = f.transy-1
			Next
		End If
	else		
		Dim ssp_i54
		If IsArray(ram_BL) Then
			For ssp_i54 = 0 To UBound(ram_BL)
				Set f = ram_BL(ssp_i54)
				f.transy = f.transy+1
			Next
		End If
	end if
	...
	if ram_BM_Dark_Room.TransY >= 0 then
		...
		Dim ssp_i55
		If IsArray(ram_BL) Then
			For ssp_i55 = 0 To UBound(ram_BL)
				Set f = ram_BL(ssp_i55)
				f.transy = 0
			Next
		End If
		RamSettleTimer.UserValue = 0
...
Sub tmrDragonWings_Timer
    ...
    Dim ssp_i56
    If IsArray(Rwing_BL) Then
    	For ssp_i56 = 0 To UBound(Rwing_BL)
    		Set wi = Rwing_BL(ssp_i56)
    		wi.ObjRotY = WingSteps(Abs(i))
    	Next
    End If
    Dim ssp_i57
    If IsArray(Lwing_BL) Then
    	For ssp_i57 = 0 To UBound(Lwing_BL)
    		Set wi = Lwing_BL(ssp_i57)
    		wi.ObjRotY = WingSteps(Abs(i))*-1
    	Next
    End If
...
Sub DoMysteryAward
    ...
    For i = 1 to 18+RndNbr(10)
        If ssp_idx(MysteryAwards(i), 1) =< CurrentGold And MysteryAwardGoNoGo(i) Then MysteryVals(2) = i
    Next
    Do
        i = RndNbr(28)
        j = j + 1
    Loop Until (ssp_idx(MysteryAwards(i), 1) =< CurrentGold And i <> MysteryVals(2) And MysteryAwardGoNoGo(i)) Or j = 100
...
Sub SelectMysteryAward
    ...
    If combo = 0 then combo = 1
    vpx_ssc_tmp = MysteryVals(MysterySelected) : Select Case vpx_ssc_tmp
        Case 0: 'keep gold
        Case 1
    ...
    End Select
    CurrentGold = CurrentGold - ssp_idx(MysteryAwards(MysteryVals(MysterySelected)), 1)
...
Sub tmrBumperRing1_Timer
    ...
    End Select
    Dim ssp_i58
    If IsArray(Bumper_Ring_BL) Then
    	For ssp_i58 = 0 To UBound(Bumper_Ring_BL)
    		Set b = Bumper_Ring_BL(ssp_i58)
    		b.TransZ = z
    	Next
    End If
End Sub
...
Sub tmrBumperRing2_Timer
    ...
    End Select
    Dim ssp_i59
    If IsArray(Bumper_Ring_001_BL) Then
    	For ssp_i59 = 0 To UBound(Bumper_Ring_001_BL)
    		Set b = Bumper_Ring_001_BL(ssp_i59)
    		b.TransZ = z
    	Next
    End If
End Sub
...
Sub tmrBumperRing3_Timer
    ...
    End Select
    Dim ssp_i60
    If IsArray(Bumper_Ring_002_BL) Then
    	For ssp_i60 = 0 To UBound(Bumper_Ring_002_BL)
    		Set b = Bumper_Ring_002_BL(ssp_i60)
    		b.TransZ = z
    	Next
    End If
End Sub
...
Sub doPictoPops(b)
    ...
    ' We have a winner!
    i = BumperVals(0)
    debug.print "PictoPops: Award " & ssp_idx(PictoPops(i), 0)
...
Sub GeneratePictoAward(b)
    ...
    Do While foundval = False
        ...
        For i = 1 to BumperAwards
            If tmp < ssp_idx(PictoPops(i), 2) Then Exit For
            tmp = tmp - ssp_idx(PictoPops(i), 2)
        Next
...
Function CheckPictoAward(val)
    ...
    vpx_ssc_tmp = ssp_idx(PictoPops(val) : Select Case vpx_ssc_tmp, 3)
        Case 1
...
Sub tmrMoveSword_Timer
    ...
    End If
    Dim ssp_i61
    If IsArray(sword_003_BL) Then
    	For ssp_i61 = 0 To UBound(sword_003_BL)
    		Set s = sword_003_BL(ssp_i61)
    		s.ObjRotY = Y
    	Next
    End If
    Dim ssp_i62
    If IsArray(sword_002_BL) Then
    	For ssp_i62 = 0 To UBound(sword_002_BL)
    		Set s = sword_002_BL(ssp_i62)
    		s.TransZ = X : s.TransX = Z
    	Next
    End If
...
Sub LockPost(up)
    ...
    Dim ssp_i63
    If IsArray(lockpost_001_BL) Then
    	For ssp_i63 = 0 To UBound(lockpost_001_BL)
    		Set lp = lockpost_001_BL(ssp_i63)
    		lp.TransZ = Z
    	Next
    End If
    DOF 123,DOFPulse
    ...
    If bUseFlexDMD Then
        If IsEmpty(PictoScene) Then
            ...
            For i = 0 to 2
                ...
                End With
                PictoScene.AddActor FlexDMD.NewLabel("pop"&i, FlexDMD.NewFont("FlexDMD.Resources.teeny_tiny_pixls-5.fnt", vbWhite, vbWhite, 0), ssp_idx(PictoPops(BumperVals(i)), 0))
        ...
        Else
            ...
            For i = 0 to 2
                Set poplabel = PictoScene.GetLabel("pop"&i)
                With poplabel
                    .Text = ssp_idx(PictoPops(BumperVals(i)), 0)
...
Sub DMDMysteryAwardScene
    ...
    If bUseFlexDMD Then
        If IsEmpty(MysteryScene) Then
            ...
            For i = 0 to 2
                ...
                With MysteryScene.GetFrame("popbox" & i)
                    ...
                    .SetBounds i*42, 0, 43, 32      ' Each frame is 43W by 32H, and offset by 0, 42, or 84 pixels
                End With
                line1 = ssp_idx(MysteryAwards(MysteryVals(i)), 0) & vbLf & ssp_idx(MysteryAwards(MysteryVals(i)), 1) & " GOLD"
                vpx_ssc_tmp = MysteryVals(i) : Select Case vpx_ssc_tmp
                    Case 0: line1 = "KEEP MY" & vbLf & CurrentGold & " GOLD"
                    Case 1,18,28
                        combo = ROrbitsw31.UserValue : If combo > 9 Then combo = combo - 10
                        If combo = 0 then combo = 1
                        line1 = CStr(ssp_idx(MysteryAwards(MysteryVals(i)), 0)*PlayfieldMultiplierVal*combo) & vblf & _
                             "MILLION" & vbLf & "POINTS" & vbLf & ssp_idx(MysteryAwards(MysteryVals(i)), 1) & " GOLD"
                End Select
        ...
        End If
    Else
        DisplayDMDText ssp_idx(MysteryAwards(MysteryVals(i)), 0),ssp_idx(MysteryAwards(MysteryVals(i)), 1) & " GOLD",0
    End If
End Sub
...
Set ssp_newobj = new DropTarget : Set DT7 = ssp_newobj(target7, target7a, T7_BM_Dark_Room, 1, 0, false)
Set ssp_newobj = new DropTarget : Set DT8 = ssp_newobj(target8, target8a, T8_BM_Dark_Room, 2, 0, false)
Set ssp_newobj = new DropTarget : Set DT9 = ssp_newobj(target9, target9a, T9_BM_Dark_Room, 3, 0, false)
Set ssp_newobj = new DropTarget : Set DT90= ssp_newobj(target90, target90a, T90_BM_Dark_Room,  4, 0, true)
Dim DTArray
...
Set ssp_newobj = new StandupTarget : Set ST04 = ssp_newobj(Target32, targets_004_BM_Dark_Room, 4,  0)
Set ssp_newobj = new StandupTarget : Set ST05 = ssp_newobj(Target33, targets_005_BM_Dark_Room, 5,  0)
Set ssp_newobj = new StandupTarget : Set ST06 = ssp_newobj(Target34, targets_006_BM_Dark_Room, 6,  0)
Set ssp_newobj = new StandupTarget : Set ST07 = ssp_newobj(Target35, targets_007_BM_Dark_Room, 7,  0)
Set ssp_newobj = new StandupTarget : Set ST08 = ssp_newobj(Target36, targets_008_BM_Dark_Room, 8,  0)
Set ssp_newobj = new StandupTarget : Set ST09 = ssp_newobj(Target43, targets_009_BM_Dark_Room, 9,  0)
Set ssp_newobj = new StandupTarget : Set ST10 = ssp_newobj(Target44, targets_010_BM_Dark_Room, 10, 0)
Set ssp_newobj = new StandupTarget : Set ST11 = ssp_newobj(Target82, targets_011_BM_Dark_Room, 11, 0)
Set ssp_newobj = new StandupTarget : Set ST12 = ssp_newobj(Target81, targets_012_BM_Dark_Room, 12, 0)
Set ssp_newobj = new StandupTarget : Set ST13 = ssp_newobj(Target80, targets_BM_Dark_Room    , 13, 0)
...
Sub FadeMaterialColoredBulb(pri, group, ByVal aLvl)	'cp's script
	...
	if Lampz.UseFunction then aLvl = Lampz.FilterOut(aLvl)	'Callbacks don't get this filter automatically
	vpx_ssc_tmp = FlashLevelToIndex(aLvl, 3) : Select case vpx_ssc_tmp
...
Function ColtoArray(aDict)	'converts a collection to an indexed array. Indexes will come out random probably.
	...
	dim count : count = 0
	Dim x, ssp_i2
	If IsArray(aDict) Then
		For ssp_i2 = 0 To UBound(aDict)
			Set x = aDict(ssp_i2)
			set a(Count) = x : count = count + 1
		Next
	End If
		...
		dim x,xx : for x = 0 to uBound(OnOff)
			if not Loaded(x) then
				if IsArray(obj(x) ) Then	'if array
					If UseFunction then
						Dim ssp_c64 : ssp_c64 = obj(x)
						Dim ssp_i64
						If IsArray(ssp_c64) Then
							For ssp_i64 = 0 To UBound(ssp_c64)
								Set xx = ssp_c64(ssp_i64)
								xx.IntensityScale = cFilter(Lvl(x)*Mult(x))
							Next
						End If
					Else
						Dim ssp_c65 : ssp_c65 = obj(x)
						Dim ssp_i65
						If IsArray(ssp_c65) Then
							For ssp_i65 = 0 To UBound(ssp_c65)
								Set xx = ssp_c65(ssp_i65)
								xx.IntensityScale = Lvl(x)*Mult(x)
							Next
						End If
					End If
...
Sub Options_OnOptChg
	...
	ElseIf OptPos = Opt_Info_2 Then
		...
		If 0 = 0 Then OptBot.Text = "DEFAULT"
		If 0 = 1 Then OptBot.Text = "STEREO 3D"
		If 0 = 2 Then OptBot.Text = "VR"
...
Sub UpdateMods
	...
	if 0 = 2 Then
		...
		if (CabinetMode <> 0  And bHaveLockbarButton = 0) then enabled=1 else enabled=0 
		'if (CabinetMode <> 1 And 0 <> 2 And bHaveLockbarButton = 0) then enabled=1 else enabled=0
	end if

    nenabled = 1-enabled
    Dim ssp_i66
    If IsArray(ApronFButton_BL) Then
    	For ssp_i66 = 0 To UBound(ApronFButton_BL)
    		Set y = ApronFButton_BL(ssp_i66)
    		y.visible=abs(enabled)
    	Next
    End If
    Dim ssp_i67
    If IsArray(fb_base_BL) Then
    	For ssp_i67 = 0 To UBound(fb_base_BL)
    		Set y = fb_base_BL(ssp_i67)
    		y.visible=abs(enabled)
    	Next
    End If
    Dim ssp_i68
    If IsArray(LockdownButton_BL) Then
    	For ssp_i68 = 0 To UBound(LockdownButton_BL)
    		Set y = LockdownButton_BL(ssp_i68)
    		y.visible = nenabled
    	Next
    End If
    Dim ssp_i69
    If IsArray(fl_base_BL) Then
    	For ssp_i69 = 0 To UBound(fl_base_BL)
    		Set y = fl_base_BL(ssp_i69)
    		y.visible = nenabled
    	Next
    End If
	
    'if CabinetMode=0 then enabled=1 else enabled=0
	if CabinetMode=0 or 0=2 then enabled=1 else enabled=0
...
Sub MovableHelper
    ...
    ' Upper PF flippers
    Dim ssp_i70
    If IsArray(LFlogo_001_BL) Then
    	For ssp_i70 = 0 To UBound(LFlogo_001_BL)
    		Set f = LFlogo_001_BL(ssp_i70)
    		f.RotZ = lfa
    	Next
    End If
	Dim ssp_i71
	If IsArray(RFlogo_001_BL) Then
		For ssp_i71 = 0 To UBound(RFlogo_001_BL)
			Set f = RFlogo_001_BL(ssp_i71)
			f.RotZ = rfa
		Next
	End If
    ...
    ' Main FP flippers
    Dim ssp_i72
    If IsArray(LFlogo_003_BL) Then
    	For ssp_i72 = 0 To UBound(LFlogo_003_BL)
    		Set f = LFlogo_003_BL(ssp_i72)
    		f.RotZ = lfa
    	Next
    End If
	Dim ssp_i73
	If IsArray(RFlogo_003_BL) Then
		For ssp_i73 = 0 To UBound(RFlogo_003_BL)
			Set f = RFlogo_003_BL(ssp_i73)
			f.RotZ = rfa
		Next
	End If
    ...
    x2 = Remk.RotX
    Dim ssp_i74
    If IsArray(LEMK_BL) Then
    	For ssp_i74 = 0 To UBound(LEMK_BL)
    		Set f = LEMK_BL(ssp_i74)
    		f.RotY = x1
    	Next
    End If
    Dim ssp_i75
    If IsArray(REMK_BL) Then
    	For ssp_i75 = 0 To UBound(REMK_BL)
    		Set f = REMK_BL(ssp_i75)
    		f.RotY = x2*-1
    	Next
    End If
    ...
    Dim ssp_i76
    If IsArray(Spinners_BL) Then
    	For ssp_i76 = 0 To UBound(Spinners_BL)
    		Set f = Spinners_BL(ssp_i76)
    		f.RotX = a
    	Next
    End If
    ...
    Dim ssp_i77
    If IsArray(Gates_001_BL) Then
    	For ssp_i77 = 0 To UBound(Gates_001_BL)
    		Set t = Gates_001_BL(ssp_i77)
    		t.RotZ=a
    	Next
    End If
...
Sub TargetMovableHelper
    ...
    Dim ssp_i78
    If IsArray(T90_BL) Then
    	For ssp_i78 = 0 To UBound(T90_BL)
    		Set t = T90_BL(ssp_i78)
    		t.transz = T90_BL(0).transz : t.rotx = T90_BL(0).rotx : t.roty = T90_BL(0).roty
    	Next
    End If

    ' LoL Drop Targets
    Dim ssp_i79
    If IsArray(T7_BL) Then
    	For ssp_i79 = 0 To UBound(T7_BL)
    		Set t = T7_BL(ssp_i79)
    		t.transz = T7_BL(0).transz : t.rotx = T7_BL(0).rotx : t.roty = T7_BL(0).roty
    	Next
    End If
    Dim ssp_i80
    If IsArray(T8_BL) Then
    	For ssp_i80 = 0 To UBound(T8_BL)
    		Set t = T8_BL(ssp_i80)
    		t.transz = T8_BL(0).transz : t.rotx = T8_BL(0).rotx : t.roty = T8_BL(0).roty
    	Next
    End If
    Dim ssp_i81
    If IsArray(T9_BL) Then
    	For ssp_i81 = 0 To UBound(T9_BL)
    		Set t = T9_BL(ssp_i81)
    		t.transz = T9_BL(0).transz : t.rotx = T9_BL(0).rotx : t.roty = T9_BL(0).roty
    	Next
    End If

    ' Stand Up Targets
    Dim ssp_i82
    If IsArray(targets_004_BL) Then
    	For ssp_i82 = 0 To UBound(targets_004_BL)
    		Set t = targets_004_BL(ssp_i82)
    		t.transz = targets_004_BL(0).transz : t.rotx = targets_004_BL(0).rotx : t.roty = targets_004_BL(0).roty
    	Next
    End If
    Dim ssp_i83
    If IsArray(targets_005_BL) Then
    	For ssp_i83 = 0 To UBound(targets_005_BL)
    		Set t = targets_005_BL(ssp_i83)
    		t.transz = targets_005_BL(0).transz : t.rotx = targets_005_BL(0).rotx : t.roty = targets_005_BL(0).roty
    	Next
    End If
    Dim ssp_i84
    If IsArray(targets_006_BL) Then
    	For ssp_i84 = 0 To UBound(targets_006_BL)
    		Set t = targets_006_BL(ssp_i84)
    		t.transz = targets_006_BL(0).transz : t.rotx = targets_006_BL(0).rotx : t.roty = targets_006_BL(0).roty
    	Next
    End If
    Dim ssp_i85
    If IsArray(targets_007_BL) Then
    	For ssp_i85 = 0 To UBound(targets_007_BL)
    		Set t = targets_007_BL(ssp_i85)
    		t.transz = targets_007_BL(0).transz : t.rotx = targets_007_BL(0).rotx : t.roty = targets_007_BL(0).roty
    	Next
    End If
    Dim ssp_i86
    If IsArray(targets_008_BL) Then
    	For ssp_i86 = 0 To UBound(targets_008_BL)
    		Set t = targets_008_BL(ssp_i86)
    		t.transz = targets_008_BL(0).transz : t.rotx = targets_008_BL(0).rotx : t.roty = targets_008_BL(0).roty
    	Next
    End If
    Dim ssp_i87
    If IsArray(targets_009_BL) Then
    	For ssp_i87 = 0 To UBound(targets_009_BL)
    		Set t = targets_009_BL(ssp_i87)
    		t.transz = targets_009_BL(0).transz : t.rotx = targets_009_BL(0).rotx : t.roty = targets_009_BL(0).roty
    	Next
    End If
    Dim ssp_i88
    If IsArray(targets_010_BL) Then
    	For ssp_i88 = 0 To UBound(targets_010_BL)
    		Set t = targets_010_BL(ssp_i88)
    		t.transz = targets_010_BL(0).transz : t.rotx = targets_010_BL(0).rotx : t.roty = targets_010_BL(0).roty
    	Next
    End If
    Dim ssp_i89
    If IsArray(targets_011_BL) Then
    	For ssp_i89 = 0 To UBound(targets_011_BL)
    		Set t = targets_011_BL(ssp_i89)
    		t.transz = targets_011_BL(0).transz : t.rotx = targets_011_BL(0).rotx : t.roty = targets_011_BL(0).roty
    	Next
    End If
    Dim ssp_i90
    If IsArray(targets_012_BL) Then
    	For ssp_i90 = 0 To UBound(targets_012_BL)
    		Set t = targets_012_BL(ssp_i90)
    		t.transz = targets_012_BL(0).transz : t.rotx = targets_012_BL(0).rotx : t.roty = targets_012_BL(0).roty
    	Next
    End If
...
Sub HideLightHelper
    ...
    Dim g
    Dim ssp_i92
    If IsArray(aGiLights) Then
    	For ssp_i92 = 0 To UBound(aGiLights)
    		Set g = aGiLights(ssp_i92)
    		g.Visible = False
    	Next
    End If
	'l103.Visible = False
