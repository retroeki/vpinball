...
PSC_CLASS_START(Frame)
   ...
   PSC_PROP_RW(Frame, int32, Thickness)
   PSC_PROP_RW(Frame, int32, BorderColor)
   PSC_PROP_RW(Frame, bool, Fill)
   PSC_PROP_RW(Frame, int32, FillColor)
PSC_CLASS_END(Frame)
...
PSC_CLASS_START(Group)
   ...
   PSC_PROP_R(Group, int32, ChildCount)
...
PSC_CLASS_START(UltraDMD)
   ...
   PSC_FUNCTION0(UltraDMD, int32, GetMajorVersion)
   PSC_FUNCTION0(UltraDMD, int32, GetMinorVersion)
   PSC_FUNCTION0(UltraDMD, int32, GetBuildNumber)
   ...
   PSC_FUNCTION3(UltraDMD, int32, RegisterVideo, int, bool, string)
...
PSC_CLASS_START(FlexDMD)
   PSC_PROP_R(FlexDMD, int32, Version)
   PSC_PROP_RW(FlexDMD, int32, RuntimeVersion)
   PSC_PROP_RW(FlexDMD, bool, Run)
   PSC_PROP_RW(FlexDMD, bool, Show)
   PSC_PROP_RW(FlexDMD, string, GameName)
   PSC_PROP_RW(FlexDMD, int32, Width)
   PSC_PROP_RW(FlexDMD, int32, Height)
   ...
   for (FlexDMD* pFlex : flexDmds)
   {
      if ((endpointId == id.endpointId) && (pFlex->GetId() == id.resId))
      {
         ...
         if (pFlex->GetRenderMode() == RenderMode_DMD_RGB)
            ...
            return { pFlex->GetFrameId(), pFlex->UpdateLumFloatFrame() };
         return { 0, nullptr };
      }
   }
   return { 0, nullptr };
