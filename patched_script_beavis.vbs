...
Sub Table1_exit():Controller.Games("beav_butt").Settings.Value("sound_mode") =0
End Sub
...
Sub SolRun(Enabled)
	...
	If B2SOn = True Then
		On Error Resume Next : On Error Resume Next : Controller.B2SSetData 98, GOoffon  : On Error Goto 0: On Error Goto 0
	End If
End Sub
...
Sub AddLamp(nr, object)
    vpx_ssc_tmp = LampState(nr) : Select Case vpx_ssc_tmp
...
Sub RandomSoundRubber()
	vpx_ssc_tmp = RndNum(1,3) : Select Case vpx_ssc_tmp
