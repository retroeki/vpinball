...
sub timer048_timer
if ballsonplayfield > 1 then
On Error Resume Next : On Error Resume Next : Controller.B2SSetData 201, 1 'makes b2s light come on during multiball  : On Error Goto 0: On Error Goto 0
Light108.state=2
else 
if usePUP=true Then
pupevent 837'POTENTIAL_INSERTPUP - Multiball ends, stop any multiball video if playing
end if
On Error Resume Next : On Error Resume Next : Controller.B2SSetData 201, 0  : On Error Goto 0: On Error Goto 0
Light108.state=0
end If
end Sub
...
Sub b2sflash_timer
    ...
    If B2SBlink Then
                Select Case b2sstep
            Case 0
                On Error Resume Next : On Error Resume Next : Controller.B2SSetData b2satm, 0  : On Error Goto 0: On Error Goto 0
            Case 1
                On Error Resume Next : On Error Resume Next : Controller.B2SSetData b2satm, 1  : On Error Goto 0: On Error Goto 0
            Case 2
                On Error Resume Next : On Error Resume Next : Controller.B2SSetData b2satm, 0  : On Error Goto 0: On Error Goto 0
            Case 3
                On Error Resume Next : On Error Resume Next : Controller.B2SSetData b2satm, 1  : On Error Goto 0: On Error Goto 0
            ...
            Case 8
                ...
                b2sflash.enabled = 0
                for i = 1 to 7
                    On Error Resume Next : On Error Resume Next : Controller.B2SSetData i, 0  : On Error Goto 0: On Error Goto 0
                next
        End Select
     b2sstep = b2sstep + 1
    End If
...
Sub Timer059_Timer()
    If toggleState1 = 0 Then
       On Error Resume Next : On Error Resume Next : Controller.B2SSetData 1, 0  : On Error Goto 0: On Error Goto 0
       toggleState1 = 1
    Else
...
Sub Timer060_Timer()
    If toggleState2 = 0 Then
       On Error Resume Next : On Error Resume Next : Controller.B2SSetData 2, 0  : On Error Goto 0: On Error Goto 0
       toggleState2 = 1
    Else
...
Sub Timer061_Timer()
    If toggleState3 = 0 Then
       On Error Resume Next : On Error Resume Next : Controller.B2SSetData 3, 0  : On Error Goto 0: On Error Goto 0
       toggleState3 = 1
    Else
...
Sub Timer062_Timer()
    If toggleState4 = 0 Then
       On Error Resume Next : On Error Resume Next : Controller.B2SSetData 4, 0  : On Error Goto 0: On Error Goto 0
       On Error Resume Next : On Error Resume Next : Controller.B2SSetData 9, 0  : On Error Goto 0: On Error Goto 0
       toggleState4 = 1
    Else
        On Error Resume Next : On Error Resume Next : Controller.B2SSetData 4, 1  : On Error Goto 0: On Error Goto 0
        On Error Resume Next : On Error Resume Next : Controller.B2SSetData 9, 1  : On Error Goto 0: On Error Goto 0
        toggleState4 = 0
    End If
End Sub
...
Sub Timer063_Timer()
    If toggleState5 = 0 Then
       On Error Resume Next : On Error Resume Next : Controller.B2SSetData 5, 0  : On Error Goto 0: On Error Goto 0
       On Error Resume Next : On Error Resume Next : Controller.B2SSetData 10, 0  : On Error Goto 0: On Error Goto 0
       toggleState5 = 1
    Else
        On Error Resume Next : On Error Resume Next : Controller.B2SSetData 5, 1  : On Error Goto 0: On Error Goto 0
        On Error Resume Next : On Error Resume Next : Controller.B2SSetData 10, 1  : On Error Goto 0: On Error Goto 0
        toggleState5 = 0
    End If
End Sub
...
Sub Timer064_Timer()
    If toggleState6 = 0 Then
       On Error Resume Next : On Error Resume Next : Controller.B2SSetData 6, 0  : On Error Goto 0: On Error Goto 0
       toggleState6 = 1
    Else
