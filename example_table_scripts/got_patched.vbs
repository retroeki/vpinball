...
Sub tmrDragonWings_Timer
    ...
    If IsArray(Rwing_BL) Then
    	For ssp_i55 = 0 To UBound(Rwing_BL)
    		Set wi = Rwing_BL(ssp_i55)
    		wi.ObjRotY = WingSteps(Abs(i))
    	Next
    End If
    Dim ssp_i56
    If IsArray(Lwing_BL) Then
    	For ssp_i56 = 0 To UBound(Lwing_BL)
    		Set wi = Lwing_BL(ssp_i56)
...
Sub tmrBumperRing1_Timer
    ...
    If IsArray(Bumper_Ring_BL) Then
    	For ssp_i57 = 0 To UBound(Bumper_Ring_BL)
    		Set b = Bumper_Ring_BL(ssp_i57)
    		b.TransZ = z
    	Next
    End If
End Sub
...
Sub tmrBumperRing2_Timer
    ...
    If IsArray(Bumper_Ring_001_BL) Then
    	For ssp_i58 = 0 To UBound(Bumper_Ring_001_BL)
    		Set b = Bumper_Ring_001_BL(ssp_i58)
    		b.TransZ = z
    	Next
    End If
End Sub
...
Sub tmrBumperRing3_Timer
    ...
    If IsArray(Bumper_Ring_002_BL) Then
    	For ssp_i59 = 0 To UBound(Bumper_Ring_002_BL)
    		Set b = Bumper_Ring_002_BL(ssp_i59)
    		b.TransZ = z
    	Next
    End If
End Sub
...
Function CheckPictoAward(val)
    ...
    vpx_ssc_tmp = PictoPops(val) : Select Case vpx_ssc_tmp(3)
        Case 1
...
Sub tmrMoveSword_Timer
    ...
    If IsArray(sword_003_BL) Then
    	For ssp_i60 = 0 To UBound(sword_003_BL)
    		Set s = sword_003_BL(ssp_i60)
    		s.ObjRotY = Y
    	Next
    End If
    Dim ssp_i61
    If IsArray(sword_002_BL) Then
    	For ssp_i61 = 0 To UBound(sword_002_BL)
    		Set s = sword_002_BL(ssp_i61)
...
Sub LockPost(up)
    ...
    If IsArray(lockpost_001_BL) Then
    	For ssp_i62 = 0 To UBound(lockpost_001_BL)
    		Set lp = lockpost_001_BL(ssp_i62)
    		lp.TransZ = Z
    	Next
    End If
    DOF 123,DOFPulse
		...
		dim x,xx : for x = 0 to uBound(OnOff)
			if not Loaded(x) then
				if IsArray(obj(x) ) Then	'if array
					If UseFunction then
						Dim ssp_c63 : ssp_c63 = obj(x)
						Dim ssp_i63
						If IsArray(ssp_c63) Then
							For ssp_i63 = 0 To UBound(ssp_c63)
								Set xx = ssp_c63(ssp_i63)
...
Sub UpdateMods
    ...
    If IsArray(ApronFButton_BL) Then
    	For ssp_i65 = 0 To UBound(ApronFButton_BL)
    		Set y = ApronFButton_BL(ssp_i65)
    		y.visible=abs(enabled)
    	Next
    End If
    Dim ssp_i66
    If IsArray(fb_base_BL) Then
    	For ssp_i66 = 0 To UBound(fb_base_BL)
    		Set y = fb_base_BL(ssp_i66)
    		y.visible=abs(enabled)
    	Next
    End If
    Dim ssp_i67
    If IsArray(LockdownButton_BL) Then
    	For ssp_i67 = 0 To UBound(LockdownButton_BL)
    		Set y = LockdownButton_BL(ssp_i67)
    		y.visible = nenabled
    	Next
    End If
    Dim ssp_i68
    If IsArray(fl_base_BL) Then
    	For ssp_i68 = 0 To UBound(fl_base_BL)
    		Set y = fl_base_BL(ssp_i68)
    		y.visible = nenabled
    	Next
    End If
...
Sub MovableHelper
    ...
    If IsArray(LFlogo_001_BL) Then
    	For ssp_i69 = 0 To UBound(LFlogo_001_BL)
    		Set f = LFlogo_001_BL(ssp_i69)
    		f.RotZ = lfa
    	Next
    End If
	Dim ssp_i70
	If IsArray(RFlogo_001_BL) Then
		For ssp_i70 = 0 To UBound(RFlogo_001_BL)
			Set f = RFlogo_001_BL(ssp_i70)
			f.RotZ = rfa
		Next
	End If
    ...
    If IsArray(LFlogo_003_BL) Then
    	For ssp_i71 = 0 To UBound(LFlogo_003_BL)
    		Set f = LFlogo_003_BL(ssp_i71)
    		f.RotZ = lfa
    	Next
    End If
	Dim ssp_i72
	If IsArray(RFlogo_003_BL) Then
		For ssp_i72 = 0 To UBound(RFlogo_003_BL)
			Set f = RFlogo_003_BL(ssp_i72)
			f.RotZ = rfa
		Next
	End If
    ...
    If IsArray(LEMK_BL) Then
    	For ssp_i73 = 0 To UBound(LEMK_BL)
    		Set f = LEMK_BL(ssp_i73)
    		f.RotY = x1
    	Next
    End If
    Dim ssp_i74
    If IsArray(REMK_BL) Then
    	For ssp_i74 = 0 To UBound(REMK_BL)
    		Set f = REMK_BL(ssp_i74)
    		f.RotY = x2*-1
    	Next
    End If
    ...
    If IsArray(Spinners_BL) Then
    	For ssp_i75 = 0 To UBound(Spinners_BL)
    		Set f = Spinners_BL(ssp_i75)
    		f.RotX = a
    	Next
    End If
    ...
    If IsArray(Gates_001_BL) Then
    	For ssp_i76 = 0 To UBound(Gates_001_BL)
    		Set t = Gates_001_BL(ssp_i76)
    		t.RotZ=a
    	Next
    End If
...
Sub TargetMovableHelper
    ...
    If IsArray(T90_BL) Then
    	For ssp_i77 = 0 To UBound(T90_BL)
    		Set t = T90_BL(ssp_i77)
...
Sub HideLightHelper
    ...
    If IsArray(aGiLights) Then
    	For ssp_i91 = 0 To UBound(aGiLights)
    		Set g = aGiLights(ssp_i91)
    		g.Visible = False
    	Next
    End If
	'l103.Visible = False
